...
from ...app.models.registrations import SampleStatus
...
def upgrade() -> None:
    ...
    # Insert data into master table if not already inserted
    connection = op.get_bind()
    master_table = connection.execute(sa.select([SampleStatus])).fetchall()
